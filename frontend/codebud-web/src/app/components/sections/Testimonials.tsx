...
function TestimonialCard({ t }: { t: (typeof testimonials)[0] }) {
    return (
        <div className="group relative w-[340px] sm:w-[380px] flex-shrink-0 bg-card backdrop-blur-sm border border-border rounded-xl p-6 mx-2 transition-all duration-500 hover:border-primary/15 hover:bg-card hover:">
            ...
            <div className="absolute top-4 right-5 text-4xl font-serif text-primary/[0.06] leading-none select-none">
                "
            </div>
            ...
            {/* Quote */}
            <p className="text-muted-foreground text-sm leading-relaxed mb-5 group-hover:text-muted-foreground transition-colors duration-300">
                "{t.quote}"
            </p>

            {/* Author */}
            <div className="flex items-center gap-3">
                <div className={`w-9 h-9 rounded-full bg-gradient-to-br ${t.color} flex items-center justify-center text-[11px] font-bold text-foreground ring-2 ring-transparent group-hover:ring-primary/20 transition-all duration-300`}>
                    {t.avatar}
                </div>
                <div>
    ...
    return (
        <section className="py-28 overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 text-center mb-16">
                ...
                >
                    Loved by{" "}
                    <span className="text-primary">10,000+ developers</span>
                </motion.h2>
