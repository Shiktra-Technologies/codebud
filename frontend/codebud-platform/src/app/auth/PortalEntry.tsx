...
export default function PortalEntry({ portalRole }: { portalRole: string }) {
    ...
    useEffect(() => {
        // Ref guard: StrictMode double-invokes effects in dev, which fired the
        // login-url request twice. Starting the redirect once is enough.
    ...
    if (error) {
        return (
            <div className="min-h-screen bg-surface-0 honeycomb-bg flex flex-col items-center justify-center">
