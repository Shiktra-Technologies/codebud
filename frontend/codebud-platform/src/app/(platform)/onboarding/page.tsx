...
export default function OnboardingPage() {
    ...
    // Stable key for fetch effects: the `user` object gets a new identity on
    // every auth refresh, which would re-fire mount fetches.
    const userKey = (user as any)?._id || (user as any)?.id || user?.email || "";
