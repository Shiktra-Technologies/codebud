        ...
        return (
            <div className="min-h-screen bg-surface-0 flex items-center justify-center p-4">
                <div className="max-w-lg w-full bg-surface-2/50 rounded-2xl border border-white/[0.06] p-8 text-center">
                    {/* The aptitude question bank isn't live yet — present this as an
                        intentional coming-soon state, not an error. */}
                    <div className="w-14 h-14 mx-auto mb-5 rounded-2xl bg-yellow-400/10 border border-yellow-400/20 flex items-center justify-center">
                        <Sparkles className="w-7 h-7 text-yellow-400" />
                    </div>
                    <h1 className="text-xl font-bold text-white mb-2">Aptitude Tests Coming Soon</h1>
                    <p className="text-sm text-white/35 mb-6">
                        We&apos;re building the aptitude question bank. Check back soon — in the
                        meantime, sharpen your skills with DSA problems and courses.
                    </p>
