    ...
    return (
        <div
            className={cn(
                ...
                s.w,
                s.h,
                "group-hover:scale-110 transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]",
                className,
            )}
        >
            <svg viewBox="0 0 52 60" className="absolute inset-0 w-full h-full">
                <path
                    ...
                    stroke="currentColor"
                    strokeWidth="1"
                    className="text-yellow-400/35 group-hover:text-yellow-400/60 transition-colors duration-300"
                />
                <path
                    d="M26 1 L50.5 15 V45 L26 59 L1.5 45 V15 Z"
                    className="fill-yellow-400/[0.09] group-hover:fill-yellow-400/[0.18] transition-colors duration-300"
                />
            </svg>
