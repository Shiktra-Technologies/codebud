  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        brand:
          "bg-yellow-400 text-surface-0 font-semibold hover:bg-yellow-300 shadow-[0_0_32px_rgba(255,193,7,0.15)] hover:shadow-[0_0_48px_rgba(255,193,7,0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]",
        brandOutline:
          "bg-white/[0.04] border border-white/[0.08] text-white/80 font-medium hover:bg-white/[0.08] hover:border-white/[0.12] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]",
      },
      size: {
